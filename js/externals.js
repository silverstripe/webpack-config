...
module.exports = (ENV, PATHS, module) => {
  const exports = {
    'silverstripe/admin/js': {
      ...
      'components/Modal/ModalCloseButton': 'ModalCloseButton',
      ...
      'legacy/ReactComponents/LegacyCheckboxSetField': 'LegacyCheckboxSetField',
      'legacy/ReactComponents/LegacyCompositeField': 'LegacyCompositeField',
      'legacy/ReactComponents/LegacyFieldGroup': 'LegacyFieldGroup',
      'legacy/ReactComponents/LegacyFieldHolder': 'LegacyFieldHolder',
      'legacy/ReactComponents/LegacyFormAction': 'LegacyFormAction',
      'legacy/ReactComponents/LegacyHiddenField': 'LegacyHiddenField',
